...
This site includes a site guide. The guide includes several docs which are coded into the file system. These docs, like this one, cannot be edited or deleted from the dashboard.
